...
!include "vortex_1_1_sasl_optional_files.nsh"

  File "test\libgsasl-7.dll"
SectionEnd

Section "noPoll Associated binaries" SEC032
  SetOutPath "$INSTDIR\bin"
  SetOverwrite ifnewer

  File "test\libnopoll.dll"
SectionEnd
...
; include sasl support
  SetOutPath "$INSTDIR\include"
  File "${GSASL_INCLUDE_DIR}\gsasl-compat.h"
  File "${GSASL_INCLUDE_DIR}\gsasl-mech.h"
  File "${GSASL_INCLUDE_DIR}\gsasl.h"
...
LangString DESC_SEC031 ${LANG_ENGLISH} "Gnu SASL binaries. Vortex Library 1.1 SASL Extension depends on GSASL . However, if you have an already working installation you can skip it."

LangString DESC_SEC032 ${LANG_ENGLISH} "noPoll binaries. Vortex Library 1.1 WebSocket Extension depends on GSASL . However, if you have an already working installation you can skip it."
...
LangString DESC_SEC13 ${LANG_ENGLISH} "Includes libvortex-websocket-1.1.dll extension library for WebSocket support"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC032} $(DESC_SEC032)
