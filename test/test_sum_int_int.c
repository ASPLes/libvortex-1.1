...
/* This is a support function to invoke 'sum' service , do not modify it!! */
XmlRpcMethodResponse * __sum_2_int_int (XmlRpcMethodCall * method_call, VortexChannel * channel)
{
	...
	result = sum_2_int_int (method_call_get_param_value_as_int (method_call, 0), method_call_get_param_value_as_int (method_call, 1),  &fault_error, &fault_code, channel);
