:mod:`vortex.channelpool` --- LuaVortexChannelPool class: channel pools
=======================================================================
...
.. class:: ChannelPool
   ...
   .. method:: next_ready (channelpool, [auto_inc], [user_data])
      ...
      :param channelpool: The channel pool where to get a channel.
      :type  channelpool: vortex.channelpool
      ...
      :rtype: a reference to vortex.Channel or nil if it fails. nil can be returned if auto_inc is not defined or set to false and no ready channel is available.

   .. method:: release (channelpool, channel)
   ...
   .. method:: check (channelpool)

      Allows to check if the provided reference is a vortex.channelpool.
   
      :param channelpool: The channel pool where to get a channel.
      :type  channelpool: vortex.channelpool

      :rtype: true if the object represents a vortex.channelpool, otherwise false is returned.
