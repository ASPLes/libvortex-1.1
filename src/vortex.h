...
#define VORTEX_ECONNREFUSED    ECONNREFUSED
#define VORTEX_EHOSTUNREACH    EHOSTUNREACH
#define VORTEX_ENETUNREACH     ENETUNREACH
#define VORTEX_ECONNRESET      ECONNRESET
#define VORTEX_ETIMEDOUT       ETIMEDOUT
...
#define VORTEX_ECONNREFUSED    WSAECONNREFUSED
#define VORTEX_EHOSTUNREACH    WSAEHOSTUNREACH
#define VORTEX_ENETUNREACH     WSAENETUNREACH
#define VORTEX_ECONNRESET      WSAECONNRESET
#define VORTEX_ETIMEDOUT       WSAETIMEDOUT
