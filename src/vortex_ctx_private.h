...
struct _VortexCtx {
	...
	int                  backlog;
	int                  enforce_profiles_supported;
	int                  automatic_mime;
	...
	int                  connection_enable_sanity_check;
	...
	int                  connection_timeout_checked;
	char              *  connection_timeout_str;
	long int             connection_connect_std_timeout;
	int                  connection_connect_timeout_checked;
	 ...
	 */
	int                       reader_accept_msgno_startig_from_1;

	/* @internal Value that allows the vortex to accept remote
	 * BEEP peer to reuse msgno 0 for channel 0.
	 */
	int                       reader_accept_reuse_msgno0_for_channel0;
	 ...
	 */
	int                       thread_pool_exclusive;
	VortexThreadPool *        thread_pool;
	int                       thread_pool_being_stoped;
