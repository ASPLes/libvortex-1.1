...
void    vortex_errno_show_error        (int  __errno)
{
	...
	switch (errno) {
	case WSAEINTR:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEINTR);
	case WSAEACCES:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEACCES);
	case WSAEFAULT:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEFAULT);
	case WSAEINVAL:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEINVAL);
	case WSAEMFILE:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEFAULT);
	case WSAEWOULDBLOCK:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEWOULDBLOCK);
	case WSAEINPROGRESS:        
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEINPROGRESS);
	case WSAEALREADY:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEALREADY);           
	case WSAENOTSOCK:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAENOTSOCK);
	case WSAEDESTADDRREQ:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEDESTADDRREQ);
	case WSAEMSGSIZE:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEMSGSIZE);           
	case WSAEPROTOTYPE:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEPROTOTYPE);
	case WSAENOPROTOOPT:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAENOPROTOOPT);
	case WSAEPROTONOSUPPORT:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEPROTONOSUPPORT);
	case WSAESOCKTNOSUPPORT:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAESOCKTNOSUPPORT);
	case WSAEOPNOTSUPP:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEOPNOTSUPP);
	case WSAEPFNOSUPPORT:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEPFNOSUPPORT);
	case WSAEAFNOSUPPORT:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEAFNOSUPPORT);
	case WSAEADDRINUSE:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEADDRINUSE);
	case WSAEADDRNOTAVAIL:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEADDRNOTAVAIL);
	case WSAENETDOWN:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAENETDOWN);
	case WSAENETUNREACH:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAENETUNREACH);
	case WSAENETRESET:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAENETRESET);
	case WSAECONNABORTED:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAECONNABORTED);
	case WSAECONNRESET:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAECONNRESET);
	case WSAENOBUFS:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAENOBUFS);
	case WSAEISCONN:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEISCONN);
	case WSAENOTCONN:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAENOTCONN);
	case WSAESHUTDOWN:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAESHUTDOWN);
	case WSAETIMEDOUT:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAETIMEDOUT);
	case WSAECONNREFUSED:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAECONNREFUSED);
	case WSAEHOSTDOWN:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEHOSTDOWN);
	case WSAEHOSTUNREACH:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEHOSTUNREACH);
	case WSAEPROCLIM:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEPROCLIM);
	case WSASYSNOTREADY:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSASYSNOTREADY);
	case WSAVERNOTSUPPORTED:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAVERNOTSUPPORTED);
	case WSANOTINITIALISED:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSANOTINITIALISED);
	case WSAEDISCON:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAEDISCON);
	case WSATYPE_NOT_FOUND:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSATYPE_NOT_FOUND);     
	case WSAHOST_NOT_FOUND:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSAHOST_NOT_FOUND);
	case WSATRY_AGAIN:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSATRY_AGAIN);
	case WSANO_RECOVERY:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSANO_RECOVERY);
	case WSANO_DATA:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSANO_DATA);            
	case WSA_INVALID_HANDLE:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSA_INVALID_HANDLE);
	case WSA_INVALID_PARAMETER:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSA_INVALID_PARAMETER);
	case WSA_IO_INCOMPLETE:     
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSA_IO_INCOMPLETE);
	case WSA_IO_PENDING:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSA_IO_PENDING);
	case WSA_NOT_ENOUGH_MEMORY:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSA_NOT_ENOUGH_MEMORY);
	case WSA_OPERATION_ABORTED:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSA_OPERATION_ABORTED);
	case WSASYSCALLFAILURE:
		vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL,  ERRNO_WSASYSCALLFAILURE);
	}
#elif defined (AXL_OS_UNIX)
	/* show the last error */
	vortex_log (LOG_DOMAIN, VORTEX_LEVEL_CRITICAL, strerror (errno));
#endif
	return;
}
